...
#define CONFIG_USERNAME_MAX_LEN 64U
#define CONFIG_PASSWORD_MAX_LEN 64U
#define CONFIG_PATH_DEFAULT   "/etc/c1/c1_app.conf"
#include <stdint.h>
...
struct AppConfig {
    ...
    char     mqtt_username[CONFIG_USERNAME_MAX_LEN];
